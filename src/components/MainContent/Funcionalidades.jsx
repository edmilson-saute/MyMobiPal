    ...
    return (
        <section>
            <div className="container-2 w-full h-auto flex flex-col lg:mt-10 lg:flex-row ">
                <img src={Phone} className='w-[70%] h-[70%] object-cover mt-4 mx-auto lg:w-[50%] lg:h-[50%]' alt="" />
                <div className='xl:mt-20'>
                    ...
                    <ul className='list-none mt-4 space-y-4'>
                        <li className='flex flex-row'>
                            <img src={CheckCircleIcon} alt="" className="ml-4 w-[8%] h-[8%] object-cover md:w-[6%] md:h-[6%]" />
